...
Proof.
  intros. induction l as [| h t].
  - reflexivity.
  - unfold fold_length. simpl. rewrite <- IHt. unfold fold_length. reflexivity.
Qed.
(** [] *)
...
Proof.
  intros. induction l as [| h t].
  - reflexivity.
  - unfold fold_map. simpl. rewrite -> IHt. unfold fold_map. reflexivity.
Qed.
(** [] *)
